    ...
    <section class="section has-background-black mb-6">
        ...
        <article class="container mt-6s">
            <div class="notification is-primary box" style="font-size: 25px;background-color: white;color:black">
                <div class="" >
                    <h2>STATUS: {{$order->delivery_status}} <button class="button is-normal is-clickable has-background-warning" style="text-decoration: none;border: none;float: right"><a href="{{route('todo.edit',$order)}}">EDIT</a></button></h2>
                </div>
...
{{--                <div class=""><h2>STARTED BY: {{$order->delivered_by}}</div>--}}
