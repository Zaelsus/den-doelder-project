                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control is-invalid "
                                   name="order_number"
                                   placeholder="Number of Order e.g Order-4891"  value="{{$order->order_number}}" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <input type="number" min="1"
                                       ...
                                       placeholder="quantity for production e.g 100" value="{{$order->quantity_production}}" required>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadioInline1" name="site_location" class="custom-control-input" value="Axel" {{ $order->site_location ==="Axel" ? 'checked='.'"'.'checked'.'"' : '' }} required>
                                    <label class="custom-control-label" for="customRadioInline1">Axel</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadioInline2" name="site_location" class="custom-control-input" value="Zelzete" {{ $order->site_location==="Zelzete" ? 'checked='.'"'.'checked'.'"' : '' }}required>
