                            ...
                            <div class="card-content">
                                <div class="content">
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input type="text" class="" name="order_id" id="order_id" value="1" readonly>
{{--                                            {{$order->order_id}}--}}
                                        </div>
                                        @error('order_id')
                                ...
                                <div class="field p-2">
                                    ...
                                    <div class="control">
                                        <textarea name="action" placeholder="Action taken..."
                                                  class="textarea @error('action') is-danger @enderror">{{ old('action') }}</textarea>
                                    </div>
                                    @error('action')
                                    <p class="help is-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="field p-2">
                                    ...
                                    <div class="control">
                                        <textarea name="abnormality" placeholder="Abnormalities..."
                                                  class="textarea @error('abnormality') is-danger @enderror">{{ old('abnormality') }}</textarea>
                                    </div>
                                    @error('abnormality')
                                    <p class="help is-danger">{{ $message }}</p>
                                    @enderror
